...
export default function LandingPage({ onLogin, loginError, clearLoginError }: LandingPageProps) {
  ...
  return (
    <div className="relative min-h-screen bg-[#090d16] text-slate-100 font-sans overflow-x-hidden selection:bg-indigo-500 selection:text-white">
      ...
      {/* Header */}
      <header className="relative max-w-7xl mx-auto px-6 py-4 flex items-center justify-between z-50">
        <div className="flex items-center gap-2.5">
          <img
            src="/favicon.png"
            alt="LinkFlow Logo"
            className="w-9 h-9 rounded-xl shadow-lg border border-white/10 hover:rotate-6 transition-all duration-300 object-cover"
          />
          <span className="font-extrabold text-xl tracking-tight bg-gradient-to-r from-white via-slate-200 to-slate-400 bg-clip-text text-transparent">LinkFlow</span>
        </div>
