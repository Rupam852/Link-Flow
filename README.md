...
Built for maximum performance and cost efficiency, **Link-Flow** leverages a modern serverless stack powered by **MongoDB** and **Vercel Edge Functions** to remain **100% free forever** while scaling seamlessly to support **200,000+ monthly visits**.
...
- **Backend API**: [Express.js](https://expressjs.com/) on [Vercel Serverless Functions](https://vercel.com/docs/functions)
- **Database Engine**: [MongoDB](https://www.mongodb.com/) via [Mongoose](https://mongoosejs.com/) (For storing user profiles, links, and click counts)
- **Authentication**: [Google Firebase Auth](https://firebase.google.com/docs/auth) (Client-side secure user session & Google authentication)
...
- **npm** (v9.x or higher)
- **MongoDB Instance** (Local community edition or MongoDB Atlas free cluster)
...
3. **Configure Environment Variables:**
   Create a `.env` file in the root directory and copy the variables:
   ```env
...
The repository includes a pre-configured `vercel.json` file optimized for serverless functions routing. To deploy:

1. Install Vercel CLI or import the repository on the [Vercel Dashboard](https://vercel.com).
2. Set the environment variables in Vercel settings (including `MONGODB_URI`).
3. Deploy! Vercel will automatically configure serverless functions and build your app.
...
| **MongoDB Atlas** | Shared (M0) | **512 MB Storage** | ~250,000+ custom profiles |
| **MongoDB Operations** | Shared (M0) | **Unlimited Connections** | Easily handles 50,000+ visits / day |
